...
  // Si no se pasan argumentos devuelve 0. Si se pasa un argumento, simplemente devuélvelo
  ...
  for(var i = 0; i < arguments.length; i ++){
    resultadoDeLaMultiplicacion *= arguments[i]
  }
...
function mesesDelAño(array) {
  ...
  // Tu código:
  var arrayConLosMesesPedidos = [];
  for(var i = 0; i < array.length; i++){
    if(array [i] === "Enero" || array [i] === "Marzo" || array [i] === "Noviembre"){
      arrayConLosMesesPedidos.push(array [i]);
    }
  }if(arrayConLosMesesPedidos.length ===3 ){
    return arrayConLosMesesPedidos;
  }else{
...
function continueStatement(numero) {
  ...
  for(var i = 0; i < 10; i ++){
    if(i === 5){
      ...
      numero = numero + 2;
      arrayConValores.push(numero);
    }

  }
  return arrayConValores;
}
